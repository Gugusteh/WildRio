...
use VoteBundle\Entity\Athlete;
use VoteBundle\Form\AthleteType;
...
class AthleteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $athletes = $em->getRepository('VoteBundle:Athlete')->findAll();
    ...
    {
        $em=$this->getDoctrine()->getManager();
        $epreuves=$em->getRepository('VoteBundle:Epreuve')->findAll();
        $athlete = new Athlete();
        $form = $this->createForm('VoteBundle\Form\AthleteType', $athlete);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $athlete->setEpreuve($em->getRepository('VoteBundle:Epreuve')->findOneByName($request->request->get('epreuvename')));
            $em->persist($athlete);
            $em->flush();
    ...
    {
        $deleteForm = $this->createDeleteForm($athlete);
        $editForm = $this->createForm('VoteBundle\Form\AthleteType', $athlete);
